        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <textarea name="deskripsi_kategori" id="deskripsi_kategori" class="form-control" required></textarea>
                    <small id="error-deskripsi_kategori" class="error-text form-text text-danger"></small>
                </div>
            </div>
