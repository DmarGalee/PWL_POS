...
<h5><i class="icon fas fa-ban"></i> Konfirmasi !!!</h5>Apakah Anda ingin menghapus data seperti di bawah ini?</div>
...
<tr><th class="text-right col-3">nama_lengkap :</th><td class="col-9">{{ $user->nama_lengkap }}</td></tr>
</table>
</div>
