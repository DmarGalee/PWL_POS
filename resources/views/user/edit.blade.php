...
<div class="card card-outline card-primary">
    ...
    <div class="col-11">
        <input type="text" class="form-control" id="nama" name="nama_lengkap" value="{{ old('nama_lengkap', $user->nama_lengkap) }}" required>    old('nama_lengkap', $user->nama_lengkap) }}" required>
    @error('nama_lengkap')
    <small class="form-text text-danger">{{ $message }}</small>
    @enderror
    </div>
